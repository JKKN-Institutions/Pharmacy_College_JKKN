        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10 md:p-12">
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              {[
                'The JKKN College of Pharmacy is well equipped with learning labs and equipment to give the learners hands-on training in the field of pharmacy. The college has a sufficient number of learning labs for postgraduate training in all the major areas of pharmacy. The learning labs are well furnished and designed to permit learners ample working space. All security measures have been put in place to assist in case of emergencies. The area of the laboratories complies with PCI standards (90sqM) and the types of equipment are maintained as per PCI guidelines. Every six months an audit of chemicals is conducted by the lab attendants.',
                'The College is running postgraduate courses in five streams. Eighteen senior learners have been approved as research guides for postgraduate studies while five also guide PhD learners. The College provides each department with a separate learning lab where each learner is assigned a working table. JKKN College of Pharmacy has a long history of research. The college has been continuously updating and upgrading instruments necessary for the cutting edge. Instruments have been purchased through funds from the government, industry, and management.',
                'Other than working learning labs the college also has a Central Instrument room where common instruments as well as instruments requiring air conditioning are kept. Each instrument is operated through a SOP and a log book for efficient functioning. To provide the instrument a non-fluctuating power supply college has installed huge stabilizers and sturdy power connections.',

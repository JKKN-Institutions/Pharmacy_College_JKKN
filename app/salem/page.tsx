...
const WHATSAPP_BASE =
  'https://wa.me/919345855001?text=Hi%2C%20I%27m%20from%20Salem%20and%20interested%20in%20admission%20at%20JKKN%20Pharmacy';
...
export default function SalemPage() {
  ...
  const faqs = [
    {
      question: 'What is the best pharmacy college in Salem?',
      answer:
        'JKKN College of Pharmacy, located just 40-50 km from Salem on NH-544, is widely regarded as one of the top pharmacy colleges accessible from Salem. Approved by PCI, AICTE, NAAC and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai, it offers excellent programmes with strong placement support.',
    },
    {
      question: 'How far is JKKN Pharmacy from Salem?',
      answer:
        'JKKN Pharmacy is approximately 40-50 km from Salem city centre, which takes about 50-60 minutes by road via NH-544 (Salem-Coimbatore Highway) — direct route. Regular TN State Transport buses are available from Salem New Bus Stand to Komarapalayam every 15-20 minutes.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, JKKN Pharmacy provides separate hostel facilities for boys and girls. Students from Salem can also opt for daily commute as the campus is just 50-60 minutes away. College transport services are available from Salem and surrounding areas.',
    },
    {
      ...
      <section className="bg-[#0d2b14] text-white pt-7 sm:pt-10 md:pt-14 pb-0">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          <p className="text-xs sm:text-sm md:text-base text-gray-300 mb-6 sm:mb-8 max-w-xl mx-auto leading-relaxed">
            Under 1 hour from Salem — closer than you think. JKKN College of Pharmacy offers
            top-tier pharmacy programmes with 85%+ placement support — just under 1 hour from
            Salem via NH-544.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            <div className="flex items-baseline gap-0.5 shrink-0">
              <span className="text-4xl sm:text-5xl font-bold text-[#1a6b35]">45</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <div className="bg-white rounded-xl p-4 sm:p-5 text-left shadow-sm border border-gray-100">
              ...
              <p className="text-xs sm:text-sm text-gray-500 italic mb-4 leading-relaxed">
                [Student testimonial from Salem to be added here. Include their experience at JKKN
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 text-left shadow-sm border border-gray-100">
              <div className="text-4xl text-gray-200 font-serif leading-none mb-2">&ldquo;</div>
              <p className="text-xs sm:text-sm text-gray-500 italic mb-4 leading-relaxed">
                [Second student testimonial from Salem to be added here. Focus on the ease of

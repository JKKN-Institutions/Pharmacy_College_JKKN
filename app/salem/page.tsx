  ...
  const faqs = [
    {
      ...
      answer:
        'JKKN College of Pharmacy, located just 40-50 km from Salem on NH-544, is widely regarded as one of the top pharmacy colleges accessible from Salem. Approved by PCI and NAAC accredited, affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai, it offers excellent programmes with strong placement support.',
    },
    {

  ...
  const faqs = [
    {
      ...
      answer:
        'JKKN College of Pharmacy, located just 80-90 km from Tiruppur on NH-544 via Erode, is widely regarded as one of the top pharmacy colleges accessible from Tiruppur. Approved by PCI, AICTE, NAAC and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai, it offers excellent programmes with strong placement support.',
    },
    {
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            <div className="flex items-baseline gap-0.5 shrink-0">
              <span className="text-4xl sm:text-5xl font-bold text-[#1a6b35]">85</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <div className="bg-white rounded-xl p-4 sm:p-5 text-left shadow-sm border border-gray-100">
              ...
              <p className="text-xs sm:text-sm text-gray-500 italic mb-4 leading-relaxed">
                [Student testimonial from Tiruppur to be added here. Include their experience at
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 text-left shadow-sm border border-gray-100">
              <div className="text-4xl text-gray-200 font-serif leading-none mb-2">&ldquo;</div>
              <p className="text-xs sm:text-sm text-gray-500 italic mb-4 leading-relaxed">
                [Second student testimonial from Tiruppur to be added here. Focus on the ease of

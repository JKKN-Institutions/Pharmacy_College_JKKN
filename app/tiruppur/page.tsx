      ...
      <section className="bg-[#FBFBEE] py-8 sm:py-12 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-white rounded-xl p-6 sm:p-8 border border-gray-100 shadow-sm max-w-xl mx-auto">
            ...
            <a
              href="https://wa.me/919345855001?text=Hi%2C%20I%27m%20from%20Tiruppur%20and%20interested%20in%20JKKN%20College%20of%20Pharmacy.%20Can%20I%20connect%20with%20current%20students%3F"
              target="_blank"
              rel="noopener noreferrer"

  ...
  return (
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="max-w-6xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        ...
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">The objective of the council</h2>
        ...
        {/* The function of IIC */}
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">The function of IIC</h2>
          <ul className="space-y-3 text-sm sm:text-base text-gray-700">
            <li className="flex items-start">
              <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-gray-700 rounded-full flex-shrink-0"></span>
              <span>
        ...
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">YUKTI Innovation Repository</h2>
          <ul className="space-y-3 text-sm sm:text-base text-gray-700">
            <li className="flex items-start">
              <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-gray-700 rounded-full flex-shrink-0"></span>
              <span>
        ...
        <div className="mb-8 sm:mb-10 md:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">National Innovation and Startup Policy (NISP) Committee</h2>

          {/* Table */}
          <div className="overflow-x-auto">
            <table className="w-full border-collapse border border-gray-400 bg-[#FBFBEE]">
              <thead>

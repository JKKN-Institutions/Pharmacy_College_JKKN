...
export default function CoimbatorePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open('https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=pharmacy.jkkn.ac.in&utm_medium=organic&utm_campaign=coimbatore', '_blank');
  };
  ...
  const faqs = [
    {
      ...
      answer:
        'JKKN College of Pharmacy is a PCI-approved, NAAC-accredited pharmacy institution located 105 km from Coimbatore on NH-544. Affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai, it offers B.Pharm, M.Pharm, and Pharm.D programmes with 95%+ placement support and a 500-bed multi-specialty teaching hospital for clinical training.',
    },
    {
      question: 'What are the top 10 pharmacy colleges in Coimbatore?',
      answer:
        'JKKN College of Pharmacy holds PCI approval and NAAC accreditation with 95%+ placement rates and modern infrastructure. The college is located in Komarapalayam on NH-544, offering three pharmacy programmes with clinical training at an on-campus 500-bed teaching hospital and placements with companies including Sun Pharma, Cipla, and Apollo Pharmacy.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'B.Pharm is a four-year Bachelor degree focused on pharmaceutical sciences, manufacturing, quality control, and research. Pharm.D is a six-year Doctor of Pharmacy clinical programme emphasising patient care, hospital pharmacy, and clinical therapeutics. B.Pharm leads to industry and research careers, while Pharm.D prepares graduates for clinical pharmacy practice. JKKN College of Pharmacy offers both B.Pharm and Pharm.D programmes with PCI approval.',
    },
    {
  ...
  return (
    <div className="min-h-screen">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "JKKN College of Pharmacy is a PCI-approved, NAAC-accredited pharmacy institution in Komarapalayam, Namakkal district, located 105 km from Coimbatore on NH-544. The college offers B.Pharm, M.Pharm, and Pharm.D programmes with clinical training at a 500-bed multi-specialty teaching hospital.",
            "foundingDate": "1952",
            "address": {
              "@type": "PostalAddress",
      ...
      <SpeakableWebPageSchema
        ...
        description="JKKN College of Pharmacy is a PCI-approved, NAAC-accredited pharmacy institution located 105 km from Coimbatore on NH-544. Offers B.Pharm, M.Pharm, and Pharm.D with 95%+ placements."

...
const WHATSAPP_BASE =
  'https://wa.me/919345855001?text=Hi%2C%20I%27m%20from%20Coimbatore%20and%20interested%20in%20admission%20at%20JKKN%20Pharmacy';
  ...
  const faqs = [
    {
      ...
      answer:
        'JKKN College of Pharmacy, located just 100-110 km from Coimbatore on NH-544, is widely regarded as one of the top pharmacy colleges accessible from Coimbatore. Approved by PCI, AICTE, NAAC and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, Chennai, it offers excellent programmes with strong placement support.',
    },
    {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <div className="bg-white rounded-xl p-4 sm:p-5 text-left shadow-sm border border-gray-100">
              ...
              <p className="text-xs sm:text-sm text-gray-500 italic mb-4 leading-relaxed">
                [Student testimonial from Coimbatore to be added here. Include their experience at
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 text-left shadow-sm border border-gray-100">
              <div className="text-4xl text-gray-200 font-serif leading-none mb-2">&ldquo;</div>
              <p className="text-xs sm:text-sm text-gray-500 italic mb-4 leading-relaxed">
                [Second student testimonial from Coimbatore to be added here. Focus on the ease of

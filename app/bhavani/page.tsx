...
const config: CityLandingConfig = {
  ...
  faqs: [
    {
      question: 'Which pharmacy college is near Bhavani?',
      answer:
        'JKKN College of Pharmacy in Komarapalayam is about 8 km from Bhavani, directly across the Kaveri river. It offers B.Pharm, M.Pharm, and Pharm.D programmes with a teaching hospital and 78% placements (2024-25).',
    },
    {
      question: 'How far is JKKN Pharmacy from Bhavani?',
      answer:
        'JKKN College of Pharmacy is approximately 8 km from Bhavani, about 10-15 minutes by road. Bhavani and Komarapalayam are twin towns on opposite banks of the Kaveri river, with very frequent local buses connecting them throughout the day.',
    },
    {
      question: 'Can learners from Bhavani commute daily to JKKN Pharmacy?',
      answer:
        'Yes, easily. At about 8 km, JKKN is a short local bus ride from Bhavani — most learners from Bhavani commute daily from home. This keeps hostel and food costs at zero while still getting a full PCI-approved pharmacy education.',
    },
    {

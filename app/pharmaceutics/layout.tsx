...
const faqs = [
  ...
  },
  {
    ...
    answer: "Candidates must hold a B.Pharm degree with a minimum of 50% marks (45% for SC and ST candidates) from a PCI approved institution. A valid GPAT score is preferred for admission. Seats are filled through merit-based selection as per PCI and university norms."
  },
  {
...
export default function PharmaceuticsLayout({
  ...
  return (
    <>
      ...
      />
      {/* FaqSchema removed 2026-09-18: these 5 questions never rendered on the page (page.tsx renders its own 10 with matching JSON-LD). */}
      <BreadcrumbWrapper />
      {children}
    </>
  )

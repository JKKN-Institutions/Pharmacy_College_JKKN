      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16">
          ...
          <div className="space-y-4 sm:space-y-6 text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            {/* Section Headers */}
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-700 mt-6 sm:mt-8 md:mt-12 mb-3 sm:mb-4">
              IDENTITY OF THE INSTITUTION THROUGH IIC ACHIEVERS
            </h3>

            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-700 mt-6 sm:mt-8 mb-3 sm:mb-4">
            ...
            <div className="space-y-6 mt-6">
              <div>
                <h4 className="text-base md:text-lg lg:text-xl font-bold text-gray-700 mb-2">

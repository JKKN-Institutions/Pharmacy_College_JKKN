...
export const metadata: Metadata = {
  ...
  description: 'Health care facilities at JKKN College of Pharmacy. Medical room, first aid, doctor on call, annual health checkups and learner wellness programmes.',
  alternates: {

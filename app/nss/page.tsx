              ...
              <table className="w-full border-collapse border border-gray-400 text-xs sm:text-sm md:text-base">
                ...
                <tbody>
                  ...
                  <tr className="bg-[#FBFBEE]">
                    ...
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Dr. V. KISHOR KUMAR, N.S.S.Programme Officer, J.K.K.Nattaraja College of Pharmacy, Kumarapalayam.</td>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Mr. V. VENKATESWARAN, Associate Professor, J.K.K.Nattaraja College of Pharmacy, Kumarapalayam.</td>

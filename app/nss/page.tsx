  ...
  return (
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        ...
        {/* Subtitle */}
        <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 sm:mb-6 md:mb-8">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed text-sm sm:text-base">
          ...
          <h3 className="text-base sm:text-lg font-bold text-gray-800 mt-8">
          ...
          <h4 className="text-sm sm:text-base font-bold text-gray-800 mt-6">
            Contacting Village/Area Leaders
          </h4>
          ...
          <div className="overflow-x-auto -mx-4 xs:-mx-5 sm:mx-0">
            <div className="min-w-full inline-block align-middle px-4 xs:px-5 sm:px-0">
              <table className="w-full border-collapse border border-gray-400 text-xs sm:text-sm md:text-base">
                <thead>
                  <tr className="bg-gray-200">
                    <th className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-left font-bold text-gray-800">S.no</th>
                    <th className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-left font-bold text-gray-800">NAME OF THE POSITIONS</th>
                    <th className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-left font-bold text-gray-800">NAME OF THE MEMBER</th>
                    <th className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-left font-bold text-gray-800">Phone NUMBER</th>
                    <th className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-left font-bold text-gray-800">e-mail ID</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-[#FBFBEE]">
                    ...
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Dr. VENKATESAN M, Principal, J.K.K.Nattaraja College of Pharmacy, Komarapalayam.</td>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Dr. V. Sekar, HOD of Analysis, J.K.K.Nattaraja College of Pharmacy, Komarapalayam.</td>
                  ...
                  <tr className="bg-[#FBFBEE]">
                    ...
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Convener</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Dr. V. KISHOR KUMAR, N.S.S.Programme Officer, J.K.K.Nattaraja College of Pharmacy, Komarapalayam.</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">9361829237</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700 break-all">kishorkumar.v@jkkn.ac.in</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">4.</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Member</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Mr. V. VENKATESWARAN, Associate Professor, J.K.K.Nattaraja College of Pharmacy, Komarapalayam.</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">9789293089</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700 break-all">venkateswaran.v@jkkn.ac.in</td>
                  </tr>
                  <tr className="bg-[#FBFBEE]">
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">5.</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Member</td>
                    <td className="border border-gray-400 px-2 sm:px-4 py-2 sm:py-3 text-gray-700">Dr. V. POOVARASU, Assistant Professor, J.K.K.Nattaraja College of Pharmacy, Komarapalayam.</td>

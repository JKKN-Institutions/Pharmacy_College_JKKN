  ...
  return (
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        {/* Page Title */}
        <h1 className="text-xl xs:text-2xl sm:text-3xl lg:text-4xl font-bold text-[#0F6B3E] mb-4 sm:mb-6 md:mb-8">
        ...
        <div className="space-y-4 sm:space-y-6 md:space-y-8 text-gray-700 leading-relaxed text-sm sm:text-base">
          {/* Overview Section */}
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Overview</h2>
          ...
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Functions of the Grievance Redressal Committee</h2>
          ...
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Procedure for Lodging a Grievance</h2>
          ...
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Composition of the SGRC (As per UGC Regulations 2023)</h2>
            <div className="space-y-3">
              <div className="flex items-start">
                <span className="text-[#0F6B3E] font-bold mr-2">✓</span>
          ...
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Ombudsperson & Appeals</h2>
          ...
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Confidentiality & Anti-Retaliation Policy</h2>
            <div className="space-y-3">
              <div className="flex items-start">
                <span className="text-[#0F6B3E] font-bold mr-2">✓</span>
          ...
          {/* Ensuring Compliance */}
          <div>
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-4">Ensuring Compliance</h2>
            <div className="space-y-3">
              <div className="flex items-start">
                <span className="text-[#0F6B3E] font-bold mr-2">✓</span>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">Follow Up & Monitoring</h3>
            <p className="text-justify">
          ...
          {/* COMPOSITION Table */}
          <div>
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">COMPOSITION</h3>
          ...
          {/* WORK FLOW OF GC */}
          <div>
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">WORK FLOW OF GC</h3>
            <div className="flex flex-col items-center space-y-4 my-4 sm:my-6 md:my-8">
              {/* Step 1 */}

    ...
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Core Clinical Competencies & Skills Developed</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Clinical Pharmacy Practice */}
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Clinical Pharmacy Practice</h3>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Patient Care Services</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Hospital Pharmacy Management</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Evidence-Based Medicine</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          {/* Clinical Research */}
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Clinical Research</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Communication & Collaboration</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] mb-8">GPAT & Alternative Entrance Exams</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">M.Pharm Pharmacy Practice - Course Structure with Clinical Training</h2>
        </div>

        {/* Semester 1 */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Semester 1 - Foundation & Clinical Basics</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
        ...
        {/* Semester 2 */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Semester 2 - Advanced Therapeutics & Patient Care</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
        ...
        {/* Semester 3 */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Semester 3 - Clinical Rotations & Research Phase I</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
        ...
        {/* Semester 4 */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Semester 4 - Advanced Clinical Practice & Research Phase II</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Career Opportunities After M.Pharm Pharmacy Practice</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Clinical Pharmacist (Hospital) */}
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Clinical Pharmacist (Hospital)</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Drug Information Specialist</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Clinical Research Coordinator</h3>
            <div className="mb-4">
          ...
          {/* Medical Writer */}
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Medical Writer</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Pharmacovigilance Associate</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Community Pharmacy Manager</h3>
            <div className="mb-4">
              <span className="inline-block bg-[#4CAF50] text-white px-4 py-2 rounded-full font-bold text-sm">₹4-8 Lakhs/Year</span>
            </div>
            <ul className="space-y-2 text-gray-700">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Medical Affairs Specialist</h3>
            <div className="mb-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Top Recruiters for M.Pharm Pharmacy Practice Graduates</h2>
        </div>

        {/* Corporate Hospital Chains */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Corporate Hospital Chains - Clinical Pharmacy Departments</h3>
        ...
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Government Medical Colleges & Teaching Hospitals</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Pharmaceutical Companies - Medical Affairs & Drug Safety</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Contract Research Organizations (CROs)</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div>
          <h3 className="text-2xl font-bold text-[#006837] mb-6">Pharmacy Retail Chains - Clinical Services</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Pharm.D vs M.Pharm Pharmacy Practice - Detailed Comparison</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl p-8 border-l-4 border-[#7cb983]">
          ...
          <div className="mb-6">
            <h4 className="text-xl font-bold text-[#006837] mb-4">Choose M.Pharm Pharmacy Practice if:</h4>
            <ul className="space-y-3 text-gray-800">
              <li className="flex items-start">
                <span className="text-[#006837] mr-3 mt-1">•</span>
          ...
          <div className="mb-6">
            <h4 className="text-xl font-bold text-[#006837] mb-4">Choose Pharm.D if:</h4>
            <ul className="space-y-3 text-gray-800">
              <li className="flex items-start">
                <span className="text-[#006837] mr-3 mt-1">•</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Higher Education & Research Opportunities</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl font-bold text-[#006837] mb-8">International Opportunities</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl font-bold text-[#006837] mb-8">Professional Certifications</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Admission Process & Timeline</h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#006837] mb-2">Decide on Career Path & Check Eligibility (September-October 2025)</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#006837] mb-2">GPAT Examination / Alternative Entrance (January-February 2026)</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#006837] mb-2">Result Declaration & College Research (March-May 2026)</h3>
                <p className="text-gray-700">Check GPAT results. Research M.Pharm Pharmacy Practice programs. <span className="font-bold text-[#006837]">Critical:</span> Verify hospital partnerships for clinical rotations. Visit colleges to check if they have active clinical pharmacy departments in affiliated hospitals.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#006837] mb-2">Counseling & College Selection (May-July 2026)</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#006837] mb-2">Document Verification & Admission (July-August 2026)</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#006837] mb-2">Classes & Clinical Training Begins (August 2026)</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">M.Pharm Pharmacy Practice - Fee Structure</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl font-bold text-[#006837] mb-8">Scholarships & Financial Aid</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Frequently Asked Questions</h2>
        </div>

        <div className="space-y-6">
          {/* Q1 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q1: What is M.Pharm in Pharmacy Practice?</h3>
          ...
          {/* Q2 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q2: What is the difference between Pharm.D and M.Pharm Pharmacy Practice?</h3>
          ...
          {/* Q3 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q3: What is the salary after M.Pharm Pharmacy Practice?</h3>
          ...
          {/* Q4 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q4: Is hospital training mandatory in M.Pharm Pharmacy Practice?</h3>
          ...
          {/* Q5 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q5: Can I do PhD after M.Pharm Pharmacy Practice?</h3>
          ...
          {/* Q6 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q6: Which is better: M.Pharm Pharmacy Practice or Pharmaceutics?</h3>
          ...
          {/* Q7 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q7: Are there jobs for M.Pharm Pharmacy Practice in India?</h3>
          ...
          {/* Q8 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q8: Can I work in community pharmacy after M.Pharm Pharmacy Practice?</h3>
          ...
          {/* Q9 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q9: Is M.Pharm Pharmacy Practice worth it compared to B.Pharm?</h3>
          ...
          {/* Q10 */}
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-[#006837] mb-4">Q10: What is the scope of Pharmacy Practice abroad?</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Why Choose M.Pharm in Pharmacy Practice?</h2>
        </div>

        <div className="space-y-6">
          {/* Reason 1 */}
          <div className="bg-gradient-to-br from-[#C8E6C9] to-[#A5D6A7] rounded-xl p-8 border-l-4 border-[#4CAF50]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">1. Direct Patient Impact & Meaningful Work</h3>
          ...
          {/* Reason 4 */}
          <div className="bg-gradient-to-br from-[#C8E6C9] to-[#A5D6A7] rounded-xl p-8 border-l-4 border-[#4CAF50]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">4. Diverse Career Pathways</h3>
          ...
          {/* Reason 7 */}
          <div className="bg-gradient-to-br from-[#C8E6C9] to-[#A5D6A7] rounded-xl p-8 border-l-4 border-[#4CAF50]">
            <h3 className="text-2xl font-bold text-[#006837] mb-4">7. Academic & Research Opportunities</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-16">
        <div className="flex items-center gap-3 mb-8">
          <CheckCircle className="w-10 h-10" />
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Accreditation & Quality Standards</h2>
        </div>

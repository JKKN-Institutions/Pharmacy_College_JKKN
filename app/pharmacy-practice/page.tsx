    ...
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="bg-gradient-to-r from-[#006837] to-[#7cb983] text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">M.Pharm in Pharmacy Practice 2026</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 border-l-4 border-[#7cb983] shadow-sm">
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-6 border-b-4 border-[#7cb983] pb-3 inline-block">What is M.Pharm in Pharmacy Practice?</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Core Clinical Competencies & Skills Developed</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Clinical Pharmacy Practice */}
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Clinical Pharmacy Practice</h3>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Patient Care Services</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Hospital Pharmacy Management</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Evidence-Based Medicine</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          {/* Clinical Research */}
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Clinical Research</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Communication & Collaboration</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Eligibility Criteria & Admission Requirements</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-8">GPAT & Alternative Entrance Exams</h2>
          ...
          <table className="w-full bg-white">
            ...
            <tbody>
              <tr className="border-b border-gray-200">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">National level exam by NTA. 125 MCQs, 3 hours, CBT mode. Valid for 3 years. Provides AICTE scholarship eligibility (₹12,400/month). Mandatory for government colleges.</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#FBFBEE]">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Karnataka PGCET, Maharashtra MCET, AP PGECET, TS PGECET. Required for state government college admissions.</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">University Entrance Exams</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Manipal MET, BITS HD, JNTU, Anna University entrance tests. For admission to respective universities.</td>
              </tr>
              <tr className="bg-[#FBFBEE]">
                <td className="px-6 py-4 font-bold text-[#006837]">Direct Admission (Management Quota)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Some private colleges offer direct admission based on B.Pharm marks. Higher fees than merit seats.</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">M.Pharm Pharmacy Practice - Course Structure with Clinical Training</h2>
        </div>

        {/* Semester 1 */}
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 1 - Foundation & Clinical Basics</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
        ...
        {/* Semester 2 */}
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 2 - Advanced Therapeutics & Patient Care</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
        ...
        {/* Semester 3 */}
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 3 - Clinical Rotations & Research Phase I</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
        ...
        {/* Semester 4 */}
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 4 - Advanced Clinical Practice & Research Phase II</h3>
          <div className="overflow-x-auto rounded-xl shadow-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-[#7cb983] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Career Opportunities After M.Pharm Pharmacy Practice</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Clinical Pharmacist (Hospital) */}
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Clinical Pharmacist (Hospital)</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Drug Information Specialist</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Clinical Research Coordinator</h3>
            <div className="mb-4">
          ...
          {/* Medical Writer */}
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Medical Writer</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Pharmacovigilance Associate</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Community Pharmacy Manager</h3>
            <div className="mb-4">
              <span className="inline-block bg-[#4CAF50] text-white px-4 py-2 rounded-full font-bold text-sm">₹4-8 Lakhs/Year</span>
            </div>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Medical Affairs Specialist</h3>
            <div className="mb-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Top Recruiters for M.Pharm Pharmacy Practice Graduates</h2>
        </div>

        {/* Corporate Hospital Chains */}
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Corporate Hospital Chains - Clinical Pharmacy Departments</h3>
        ...
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Government Medical Colleges & Teaching Hospitals</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Pharmaceutical Companies - Medical Affairs & Drug Safety</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-10">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Contract Research Organizations (CROs)</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div>
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Pharmacy Retail Chains - Clinical Services</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Pharm.D vs M.Pharm Pharmacy Practice - Detailed Comparison</h2>
        </div>
          ...
          <table className="w-full bg-white">
            ...
            <tbody>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">After B.Pharm (4 years UG completed)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">After 12th standard (10+2 with PCB/M)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Duration</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">2 years (4 semesters)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">6 years (5 years + 1 year internship)</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Degree Level</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Postgraduate (Master's)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Professional Doctoral (Doctor of Pharmacy)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Clinical Training</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">20-24 weeks clinical rotations in hospitals</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">1 full year (12 months) clinical internship</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Title</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">M.Pharm (cannot use "Dr." prefix)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Pharm.D (can use "Dr." prefix - academic)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Research Component</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Mandatory research project & thesis</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Limited research, more clinical practice focus</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Clinical Depth</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Moderate clinical exposure (6 months)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Extensive clinical exposure (full year internship)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Job Roles</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Clinical Pharmacist, Medical Writer, Research, Academic</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Clinical Pharmacist, Hospital Pharmacist, Patient Care</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Starting Salary</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹4-7 lakhs per annum</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹4-8 lakhs per annum</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Academic Career</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Excellent (can directly pursue Ph.D, become faculty)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Good (Ph.D eligibility with additional requirements)</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Total Investment</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">B.Pharm fees + M.Pharm fees (₹6-12 lakhs total)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹6-25 lakhs (full 6-year program)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Time to Job Market</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">6 years total (4 years B.Pharm + 2 years M.Pharm)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">6 years (direct entry after 12th)</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Hospital Preference</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Moderate (some hospitals prefer Pharm.D)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">High (specifically designed for clinical roles)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">Ph.D Eligibility</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Direct eligibility (postgraduate degree)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Requires additional PG qualification in some cases</td>
              </tr>
              <tr className="bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">Best For</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">B.Pharm graduates wanting clinical specialization + research</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">12th passouts wanting direct clinical pharmacy career</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl p-8 border-l-4 border-[#7cb983]">
          ...
          <div className="mb-6">
            <h4 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Choose M.Pharm Pharmacy Practice if:</h4>
            <ul className="space-y-3 text-gray-800">
              <li className="flex items-start">
                <span className="text-[#006837] mr-3 mt-1">•</span>
          ...
          <div className="mb-6">
            <h4 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Choose Pharm.D if:</h4>
            <ul className="space-y-3 text-gray-800">
              <li className="flex items-start">
                <span className="text-[#006837] mr-3 mt-1">•</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Higher Education & Research Opportunities</h2>
        </div>

        <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Ph.D in Pharmaceutical Sciences - Pharmacy Practice Specialization</h3>
          ...
          <table className="w-full bg-white">
            ...
            <tbody>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Life Sciences paper. Fellowship: ₹31,000/month (JRF) → ₹35,000/month (SRF)</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">UGC-NET</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Pharmacy paper. Fellowship: ₹31,000/month (JRF) → ₹35,000/month (SRF)</td>
              </tr>
              <tr className="border-b border-gray-200 bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">ICMR-JRF</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Biomedical sciences. Fellowship: ₹31,000/month → ₹35,000/month</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 font-bold text-[#006837]">GATE</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Biotechnology/Life Sciences. MHRD Fellowship: ₹31,000/month</td>
              </tr>
              <tr className="bg-[#E0F7FA]">
                <td className="px-6 py-4 font-bold text-[#006837]">University Entrance</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Individual university exams (AIIMS, JIPMER, medical colleges). University fellowships.</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-8">International Opportunities</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-8">Professional Certifications</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Admission Process & Timeline</h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">1</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">Decide on Career Path & Check Eligibility (September-October 2025)</h3>
                <p className="text-sm sm:text-base text-gray-700">Confirm interest in patient-facing clinical pharmacy career. Verify B.Pharm eligibility (55% marks). Assess communication skills and patient care aptitude. Research colleges with good hospital tie-ups for clinical rotations.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">2</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">GPAT Registration (October-November 2025)</h3>
                <p className="text-sm sm:text-base text-gray-700">Register on NTA GPAT website if targeting government colleges or AICTE scholarship. Some private colleges accept direct admission without GPAT. Pay fees (₹1,400 General, ₹700 SC/ST/OBC).</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">3</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">GPAT Examination / Alternative Entrance (January-February 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Appear for GPAT or state-level entrance exams. Focus on Pharmacology and Pharmacy Practice topics. Alternatively, apply directly to colleges accepting B.Pharm marks.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">4</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">Result Declaration & College Research (March-May 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Check GPAT results. Research M.Pharm Pharmacy Practice programs. <span className="font-bold text-[#006837]">Critical:</span> Verify hospital partnerships for clinical rotations. Visit colleges to check if they have active clinical pharmacy departments in affiliated hospitals.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">5</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">Counseling & College Selection (May-July 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Register for counseling (AICTE/state-level). Submit preferences with Pharmacy Practice specialization. Prioritize colleges with strong hospital networks. Accept seat allotment and pay fees.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">6</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">Document Verification & Admission (July-August 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Submit original documents (B.Pharm degree, mark sheets, GPAT scorecard). Complete admission formalities. Sign hospital rotation agreements. Apply for AICTE scholarship if eligible.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              <div className="bg-[#7cb983] text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl flex-shrink-0">7</div>
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-2">Classes & Clinical Training Begins (August 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Attend orientation. Start classroom learning. Prepare for clinical rotations. Learn medical terminology and patient communication skills. Get introduced to hospital preceptors.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">M.Pharm Pharmacy Practice - Fee Structure</h2>
        </div>
        ...
        <div className="overflow-x-auto rounded-xl shadow-lg mb-8">
          <table className="w-full bg-white">
            ...
            <tbody>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Government Colleges</td>
              ...
              <tr className="border-b border-gray-200 bg-[#FBFBEE]">
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Government Medical Colleges</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹1,00,000 - ₹2,00,000</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹50,000 - ₹1,00,000</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">State Government Colleges</td>
              ...
              <tr className="border-b border-gray-200 bg-[#FBFBEE]">
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Private Colleges (Affiliated)</td>
              ...
              <tr className="bg-[#FBFBEE]">
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Deemed Universities</td>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-8">Scholarships & Financial Aid</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Why Choose M.Pharm in Pharmacy Practice?</h2>
        </div>

        <div className="space-y-6">
          {/* Reason 1 */}
          <div className="bg-gradient-to-br from-[#C8E6C9] to-[#A5D6A7] rounded-xl p-8 border-l-4 border-[#4CAF50]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">1. Direct Patient Impact & Meaningful Work</h3>
          ...
          {/* Reason 2 */}
          <div className="bg-white rounded-xl p-8 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">2. Growing Demand in Healthcare Sector</h3>
          ...
          {/* Reason 3 */}
          <div className="bg-white rounded-xl p-8 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">3. Work-Life Balance & Regular Hours</h3>
          ...
          {/* Reason 4 */}
          <div className="bg-gradient-to-br from-[#C8E6C9] to-[#A5D6A7] rounded-xl p-8 border-l-4 border-[#4CAF50]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">4. Diverse Career Pathways</h3>
          ...
          {/* Reason 5 */}
          <div className="bg-white rounded-xl p-8 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">5. Interprofessional Healthcare Teamwork</h3>
          ...
          {/* Reason 6 */}
          <div className="bg-white rounded-xl p-8 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">6. Strong International Recognition</h3>
          ...
          {/* Reason 7 */}
          <div className="bg-gradient-to-br from-[#C8E6C9] to-[#A5D6A7] rounded-xl p-8 border-l-4 border-[#4CAF50]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">7. Academic & Research Opportunities</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-r from-[#00BCD4] to-[#7cb983] rounded-2xl p-12 text-center shadow-xl">
          ...
          <a href="https://admission.jkkn.ac.in/form/jkkn-institution-admission-yxs3w8" className="bg-white text-[#006837] px-8 py-4 rounded-full text-xl font-bold hover:bg-gray-100 transition-colors shadow-lg inline-block focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] border-b-4 border-[#7cb983] pb-2">Accreditation & Quality Standards</h2>
        </div>

...
const PHARMACY_PRACTICE_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Candidates must hold a B.Pharm degree with a minimum of 50% aggregate marks (45% for SC and ST candidates) from a PCI approved institution. A valid GPAT score is preferred for admission. Seats are filled based on merit and applicable state counselling norms.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'JKKN College of Pharmacy provides clinical pharmacy training through the JKKN teaching hospital. Learners gain direct patient care exposure, therapeutic drug monitoring practice, and drug information centre experience under clinical senior learner supervision.',
  },
]

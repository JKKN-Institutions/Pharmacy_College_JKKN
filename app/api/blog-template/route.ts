    ...
    sections: [
      {
        children: [
          ...
          p('5. Strategic Location & Residential Campus \u2014 Situated on NH-544 (Salem-Coimbatore Highway) at Natarajapuram, Komarapalayam, easily accessible from Erode Junction (21 km), Tiruchengode (26 km) and Salem Junction (55 km) by road. The residential campus includes hostel, library, and sports facilities.'),
          p(''),

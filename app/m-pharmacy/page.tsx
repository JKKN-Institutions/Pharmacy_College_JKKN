    ...
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="bg-gradient-to-r from-[#006837] to-[#7cb983] text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-[9px] xs:text-[10px] sm:text-xs text-gray-100">5 PCI-Approved Specialisations • NAAC A Grade • Research Excellence • GPAT/GATE Pathway</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-base xs:text-lg sm:text-xl lg:text-2xl font-bold text-[#006837]">5 M.Pharm Specialisations - Choose Your Path</h2>
        </div>

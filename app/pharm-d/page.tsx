        ...
        <div className="mt-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-[#7cb983]">
              ...
              <p className="text-xs sm:text-sm text-[#002309] mb-3">Heart failure management, anticoagulation, cardiac medication optimization</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-[#7cb983]/20 rounded-lg overflow-hidden">
              ...
              {expandedFAQ === 1 && (
                <div className="p-3 sm:p-4 bg-[#FBFBEE] border-t border-[#7cb983]/20">
                  <p className="text-[10px] xs:text-xs sm:text-xs text-[#002309]">Pharm.D graduate salaries in India vary significantly by hospital type and location. Government hospitals: ₹25,000-40,000/month for clinical pharmacist positions with job security and growth. Corporate hospitals (Apollo, Fortis, Max, Manipal): ₹30,000-60,000/month with performance incentives and better facilities. Specialty hospitals (cancer, cardiac): ₹35,000-70,000/month for specialised clinical roles. After residency programmes (1-2 years): ₹45,000-80,000/month in major metros. Experience progression: 0-2 years ₹25-40K, 3-5 years ₹40-60K, 5-10 years ₹60-90K, 10+ years ₹80K-1.5L/month. Non-hospital opportunities: Clinical research organizations ₹30-50K, pharmaceutical companies (medical affairs) ₹40-70K, regulatory affairs ₹35-65K, academia (assistant professor) ₹50-70K. International opportunities significantly higher: USA clinical pharmacist $80,000-120,000/year, Middle East ₹80K-1.5L/month tax-free, UK/Australia/Canada competitive salaries. Reality check: Entry-level positions competitive, many start with internships/fellowships at lower pay (₹15-25K) before regular positions.</p>
                </div>
              )}
            </div>

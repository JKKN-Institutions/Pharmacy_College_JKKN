      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16 space-y-10 md:space-y-14">
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-10">
            ...
            <ul className="space-y-4">
              <BulletItem text={<><strong>Enhance Practical Competence:</strong> Develop a structured experiential learning framework that enables pharmacy students to apply theoretical knowledge in real-world healthcare scenarios, thereby strengthening their practical skills.</>} />
              ...
              <BulletItem text={<><strong>Bridge Academic and Professional Realities:</strong> Create a seamless connection between classroom learning and pharmacy practice by integrating hands-on experiences, enabling students to understand the practical implications of their academic studies.</>} />
              <BulletItem text={<><strong>Foster Critical Thinking and Problem Solving:</strong> Structure experiential learning activities that challenge students to analyse complex clinical situations, make informed decisions, and develop innovative solutions, cultivating their critical thinking abilities.</>} />
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-10">
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed text-justify">
              JKKN College of Pharmacy, Komarapalayam, is dedicated to fostering a dynamic educational environment that prioritizes experiential learning as a pivotal component of its pharmacy education framework. Recognizing the significance of bridging the gap between theoretical knowledge and practical application in the field of pharmacy, the institution has undertaken a concerted effort to develop and implement a robust experiential learning programme. This programme aims to equip pharmacy students by providing them with hands-on opportunities to engage with real-world healthcare scenarios, thereby enhancing their practical competence, nurturing patient-centered care values, and fostering critical thinking skills. Through this experiential learning approach, the institution endeavors to align academic pursuits with professional realities, equipping students with the holistic skills and interdisciplinary perspectives required to excel as competent and compassionate pharmacists in today&apos;s evolving healthcare landscape.
            </p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-10">
            ...
            <div className="space-y-5">
              ...
              <ul className="space-y-4">
                ...
                <BulletItem text={<><strong>Community Engagement:</strong> Photographs, videos, or reports showcasing the active participation of students in patient counselling sessions, health camps, and other community engagement activities can serve as visual evidence of the initiative&apos;s implementation.</>} />
                <BulletItem text={<><strong>Student Query:</strong> A student at JKKN College of Pharmacy received a drug information inquiry from a healthcare professional at the local hospital. The student at the Drug Information Centre researched the medications in question, consulted relevant pharmaceutical databases, and provided a comprehensive response to the inquiry. The exchange between the student and the healthcare professional can be documented as evidence of the Drug Information Centre&apos;s effectiveness. Additionally, tracking similar interactions and compiling a record of inquiries, responses, and outcomes can provide a broader picture of how the Drug Information Centre is contributing to practical learning and problem-solving for students.</>} />
                <BulletItem text={<><strong>Published Resources:</strong> Students of JKKN College of Pharmacy have contributed to Newsletter publications, articles, or presentations that can demonstrate their active involvement and the practical impact of the Centre.</>} />
              </ul>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-10">
            ...
            <ul className="space-y-4">
              ...
              <BulletItem text={<><strong>Training Programmes:</strong> Sessions for students on effective communication, cultural competence, and community engagement.</>} />
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-10">
            ...
            <ul className="space-y-4">
              ...
              <BulletItem text={<><strong>Hands-On Learning:</strong> Experiential learning bridges theory and practice, preparing students for real-world challenges.</>} />

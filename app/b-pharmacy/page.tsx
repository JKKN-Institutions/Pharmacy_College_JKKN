      ...
      <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        ...
        <div className="mb-4 sm:mb-6 md:mb-8">
          <div className="bg-gradient-to-r from-[#006837] via-[#7cb983] to-[#7cb983] text-white rounded-lg shadow-xl p-12 text-center">
            ...
            <a href="https://admission.jkkn.ac.in/form/jkkn-institution-admission-yxs3w8" className="bg-white text-[#006837] px-8 py-4 rounded-full text-[10px] sm:text-sm font-bold hover:bg-[#FBFBEE] transition-all shadow-lg inline-block">

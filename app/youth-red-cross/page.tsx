  ...
  return (
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="max-w-6xl mx-auto px-4 xs:px-5 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        ...
        {/* Objective of YRC */}
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">OBJECTIVE OF YRC</h2>
        ...
        {/* List of Events */}
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">LIST OF EVENTS</h2>
          <ul className="space-y-3 text-sm sm:text-base text-gray-700">
            <li className="flex items-start">
              <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-gray-700 rounded-full flex-shrink-0"></span>
              <span>

    ...
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Why Pursue Ph.D in Pharmacy?</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-[#FBFBEE]">
        <div className="flex items-start gap-4 mb-12">
          <Microscope className="w-10 h-10" />
          <div>
            <h2 className="text-3xl sm:text-4xl font-bold text-[#006837] mb-4">Ph.D Specializations in Pharmacy</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-[#7cb983]">
            ...
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Ph.D in Pharmaceutics</h3>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-[#7cb983] text-white text-xs font-semibold px-3 py-1 rounded-full">High Demand</span>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-[#7cb983]">
            ...
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Ph.D in Pharmaceutical Chemistry</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-[#7cb983]">
            ...
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Ph.D in Pharmacy Practice</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white">
        <div className="flex items-start gap-4 mb-12">
          <IndianRupee className="w-10 h-10" />
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Fellowship & Financial Support</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Ph.D Program Structure & Timeline</h2>
        </div>
          ...
          <table className="w-full bg-white rounded-lg shadow-lg">
            ...
            <tbody>
              <tr className="border-b border-gray-200">
                <td className="px-6 py-6 font-semibold text-[#006837]">Year 1</td>
              ...
              <tr className="bg-[#FBFBEE] border-b border-gray-200">
                <td className="px-6 py-6 font-semibold text-[#006837]">Year 2</td>
              ...
              <tr className="border-b border-gray-200">
                <td className="px-6 py-6 font-semibold text-[#006837]">Year 3</td>
              ...
              <tr className="bg-[#FBFBEE] border-b border-gray-200">
                <td className="px-6 py-6 font-semibold text-[#006837]">Year 4</td>
              ...
              <tr className="border-b border-gray-200">
                <td className="px-6 py-6 font-semibold text-[#006837]">Year 5-6</td>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          <Microscope className="w-10 h-10" />
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Trending Research Areas in Pharmacy Ph.D</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">Nanotechnology</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              <div className="text-5xl mb-4"><Printer className="w-6 h-6" /></div>
              <h3 className="text-xl font-bold text-[#006837] mb-3">3D Printing</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">Gene Therapy</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">AI in Drug Discovery</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              <Syringe className="w-6 h-6" />
              <h3 className="text-xl font-bold text-[#006837] mb-3">Vaccine Development</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              <Leaf className="w-6 h-6" />
              <h3 className="text-xl font-bold text-[#006837] mb-3">Phytomedicine</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">Biosimilars</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">Biomarker Discovery</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">Clinical Research</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837] mb-3">Digital Therapeutics</h3>
          ...
          <div className="text-center">
            <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
              <div className="mb-4"><Recycle className="w-12 h-12 mx-auto" /></div>
              <h3 className="text-xl font-bold text-[#006837] mb-3">Green Chemistry</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            <ClipboardList className="w-10 h-10" />
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Regulatory Affairs Expert</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Postdoctoral Researcher</h3>
            <div className="mb-4">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            <Lightbulb className="w-10 h-10" />
            <h3 className="text-2xl font-bold text-[#006837] mb-4">Entrepreneur / Consultant</h3>
            <div className="mb-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Top Institutions for Ph.D in Pharmacy in India</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">NIPER Mohali</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">NIPER Hyderabad</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">NIPER Ahmedabad</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">Jamia Hamdard Delhi</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">Manipal College of Pharmacy</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">JSS College Mysuru</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">BITS Pilani</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">ICT Mumbai</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">Panjab University</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">BHU Varanasi</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">Bombay College of Pharmacy</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">IIT BHU</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">Andhra University</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">JKKN College of Pharmacy</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">KLE University</h3>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200 text-center">
            <h3 className="text-lg font-bold text-[#006837]">NITTE University</h3>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          <FileText className="w-10 h-10" />
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Ph.D Admission Process</h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#006837] mb-3">Check Eligibility & Entrance Exam</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#006837] mb-3">Identify Research Area & Potential Guide</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#006837] mb-3">Prepare Research Proposal</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#006837] mb-3">Interview & Presentation</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#006837] mb-3">Selection & Enrollment</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          <BarChart className="w-10 h-10" />
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Ph.D vs M.Pharm: Detailed Comparison</h2>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Frequently Asked Questions (FAQs)</h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-10 h-10 bg-[#7cb983] rounded-full flex items-center justify-center text-white font-bold">
                Q
              </div>
              <h3 className="text-xl font-bold text-[#006837]">What is Ph.D in Pharmacy?</h3>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">What are the eligibility criteria for Ph.D in Pharmacy?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">What is the duration of Ph.D in Pharmacy?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">What is the fellowship/stipend during Ph.D in Pharmacy?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">Can I do Ph.D in Pharmacy after B.Pharm directly?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">What are the career opportunities after Ph.D in Pharmacy?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">What are the specializations available in Ph.D Pharmacy?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">Is GPAT mandatory for Ph.D in Pharmacy?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">What is the difference between full-time and part-time Ph.D?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-xl font-bold text-[#006837]">How many publications are required for Ph.D completion?</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-14">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-[#006837] to-[#7cb983] rounded-2xl p-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#7cb983] text-white font-bold text-lg px-10 py-4 rounded-full hover:bg-[#E55A25] transition-colors shadow-lg">
              Apply for Ph.D 2026
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-start gap-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#006837]">Accreditation & Quality Assurance</h2>
        </div>

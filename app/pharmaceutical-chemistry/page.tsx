    ...
    <div className="min-h-screen bg-[#FBFBEE]">
      ...
      <div className="bg-gradient-to-r from-[#006837] via-[#7cb983] to-[#7cb983] text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">M.Pharm in Pharmaceutical Chemistry 2026</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-br from-[#FBFBEE] via-[#FBFBEE] to-[#FBFBEE] rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 border-l-4 border-[#7cb983]">
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-6">What is M.Pharm in Pharmaceutical Chemistry?</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">Core Research Areas & Chemical Competencies</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Medicinal Chemistry & Drug Design */}
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Medicinal Chemistry & Drug Design</h3>
          ...
          {/* Organic Synthesis */}
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Organic Synthesis</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Computer-Aided Drug Design (CADD)</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Spectroscopy & Characterization</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Natural Product Chemistry</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
          ...
          <div className="bg-white rounded-xl p-6 border-2 border-[#7cb983] shadow-lg">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">Process Chemistry & Scale-Up</h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006837] mr-2">•</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">Eligibility Criteria & Prerequisites</h2>
        </div>
          ...
          <table className="w-full bg-white">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">National Testing Agency (NTA)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Exam Mode</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Computer-Based Test (CBT)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Duration</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">3 Hours (180 minutes)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Questions</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">125 Multiple Choice Questions</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Total Marks</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">500 Marks (4 marks per question)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Pharmaceutical Chemistry Weightage</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Approximately 30-35 questions (24-28%) - Highest among all subjects</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Score Validity</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">3 Years from result declaration</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Negative Marking</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">No negative marking</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">M.Pharm Pharmaceutical Chemistry - Detailed Course Structure</h2>
        </div>

        {/* Semester 1 */}
        <div className="mb-12">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 1 - Foundation & Advanced Organic Chemistry</h3>
          <div className="overflow-x-auto shadow-lg rounded-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-gradient-to-r from-[#006837] to-[#7cb983]">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  ...
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Modern Pharmaceutical Analytical Techniques</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-102</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Advanced Organic Chemistry I</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-103</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Advanced Medicinal Chemistry</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-104</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Chemistry of Natural Products</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-105</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Pharmaceutical Chemistry Practical I</td>
                  <td className="px-6 py-4 text-gray-900">12</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-106</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Seminar/ Assignment</td>
        ...
        {/* Semester 2 */}
        <div className="mb-12">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 2 - Synthetic Chemistry & Drug Discovery</h3>
          <div className="overflow-x-auto shadow-lg rounded-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-gradient-to-r from-[#006837] to-[#7cb983]">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  ...
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Advanced Spectral Analysis</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-202</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Advanced Organic Chemistry II</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-203</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Computer Aided Drug Design</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-204</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Pharmaceutical Process Chemistry</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-205</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Pharmaceutical Chemistry Practical II</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
        ...
        {/* Semester 3 */}
        <div className="mb-12">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 3 - Research Project Phase I & Synthesis</h3>
          <div className="overflow-x-auto shadow-lg rounded-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-gradient-to-r from-[#006837] to-[#7cb983]">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  ...
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Research Methodology and Biostatistics</td>
                  <td className="px-6 py-4 text-gray-900">4</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-302</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Journal Club</td>
                  <td className="px-6 py-4 text-gray-900">1</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-303</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Discussion/ Presentation (Proposal Presentation)</td>
                  <td className="px-6 py-4 text-gray-900">2</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 text-gray-900">MPC-304</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Research Work</td>
        ...
        {/* Semester 4 */}
        <div className="mb-12">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Semester 4 - Research Project Phase II & Characterization</h3>
          <div className="overflow-x-auto shadow-lg rounded-lg">
            <table className="w-full bg-white">
              <thead>
                <tr className="bg-gradient-to-r from-[#006837] to-[#7cb983]">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  ...
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Discussion Final Presentation</td>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">Career Opportunities After M.Pharm Pharmaceutical Chemistry</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Medicinal Chemist */}
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-3">Medicinal Chemist</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-3">Synthetic Chemist (R&D)</h3>
            <div className="bg-[#7cb983] text-white px-4 py-2 rounded-full inline-block text-sm font-bold mb-4">
              ₹5-9 Lakhs/Year
            </div>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
          ...
          {/* Process Chemist */}
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-3">Process Chemist</h3>
            <div className="bg-[#7cb983] text-white px-4 py-2 rounded-full inline-block text-sm font-bold mb-4">
              ₹5-10 Lakhs/Year
            </div>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-3">Analytical Research Scientist</h3>
            <div className="bg-[#7cb983] text-white px-4 py-2 rounded-full inline-block text-sm font-bold mb-4">
              ₹5-9 Lakhs/Year
            </div>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-3">Computational Chemist</h3>
            <div className="bg-[#7cb983] text-white px-4 py-2 rounded-full inline-block text-sm font-bold mb-4">
              ₹6-11 Lakhs/Year
            </div>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-3">Research Scientist (Natural Products)</h3>
            <div className="bg-[#7cb983] text-white px-4 py-2 rounded-full inline-block text-sm font-bold mb-4">
              ₹5-9 Lakhs/Year
            </div>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">Top Recruiters for M.Pharm Pharmaceutical Chemistry Graduates</h2>
        </div>

        {/* Multinational Pharmaceutical Companies */}
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Multinational Pharmaceutical Companies - Drug Discovery</h3>
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Indian Pharmaceutical Companies - R&D Centers</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Contract Research Organizations (CROs) - Chemistry Services</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div>
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Academic & Research Institutes - Ph.D. & Faculty Positions</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Indian Pharmaceutical R&D Companies</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Biotechnology & Drug Discovery Companies</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">CSIR Labs & Government Research Institutions</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div>
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Pharmacy Colleges - Academic Positions</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">M.Pharm Pharmaceutical Chemistry vs Other Specializations</h2>
        </div>
          ...
          <table className="w-full bg-white">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Drug design, organic synthesis, molecular structure modification</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Drug formulation, product development, NDDS</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Quality control, analytical testing, method validation</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Core Skills</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Organic synthesis, spectroscopy, CADD, SAR studies</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Formulation design, tablet technology, NDDS, scale-up</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">HPLC, GC-MS, LC-MS, spectroscopy, validation</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Work Nature</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Laboratory synthesis, research-intensive, chemistry-focused</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Creative, problem-solving, innovation-driven</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Protocol-driven, precision-oriented, standardized</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Prerequisite Knowledge</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Strong organic chemistry mandatory</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Formulation science, minimal organic chemistry</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Analytical techniques, basic chemistry</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Laboratory Work</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Chemical synthesis, reactions, purifications</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Formulation preparation, characterization</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Instrument operation, sample testing</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Job Departments</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Discovery Chemistry, Medicinal Chemistry, Process Chemistry</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Formulation R&D, Production, Technical Services</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">QC/QA labs, Analytical R&D, Regulatory</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Industry Demand</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Moderate (specialized drug discovery roles, research-focused)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">High (R&D companies, innovation priority)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Very High (universal need across companies)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Starting Salary</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹5-7 lakhs (medicinal chemist, synthetic chemist)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹5-8 lakhs (formulation scientist)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹4-6 lakhs (QC analyst)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Salary Growth</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Excellent (₹25-45 lakhs for head of chemistry)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Excellent (₹25-60 lakhs for senior formulation R&D)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Good (₹18-35 lakhs for QC/QA heads)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Academic Career</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Excellent (high demand for chemistry faculty)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Good (pharmaceutics faculty needed)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Moderate (analytical faculty positions)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Ph.D Opportunities</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Excellent (IITs, CSIR, drug discovery research)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Excellent (NDDS, nanotechnology research)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Good (analytical method development)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Innovation Potential</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Very High (design new molecules, patents)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Very High (novel formulations, delivery systems)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Moderate (analytical method development)</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Work Environment</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Synthesis labs, fume hoods, chemical storage</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Formulation labs, pilot plants, R&D centers</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Analytical labs, QC facilities, clean rooms</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 font-bold text-[#006837]">Best For</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Organic chemistry lovers, molecular designers, research-minded</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Creative thinkers, product developers, innovators</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Detail-oriented, precision-focused, quality-minded</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-8 border-l-4 border-[#7cb983]">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-700">Prefer product development over molecular design, want to create dosage forms not molecules, enjoy innovation in formulation rather than synthesis, seek diverse industry roles beyond research.</p>
            </div>

            <div>
              <p className="text-[#006837] font-bold text-lg mb-3">Choose Pharmaceutical Analysis if you:</p>
              <p className="text-sm sm:text-base text-gray-700">Prefer instrument operation over chemical synthesis, want standardized procedures not experimental research, are detail-oriented for quality testing, prefer consistent job availability.</p>
            </div>

            <div className="mt-6 p-4 bg-white rounded-lg">
              <p className="text-[#006837] font-bold mb-2">Key Insight:</p>
              <p className="text-sm sm:text-base text-gray-700">Pharmaceutical Chemistry is for those who genuinely love organic chemistry and chemical synthesis. It's not for those who just want to avoid other subjects or are looking for "easy" specialization. Success requires strong chemistry foundation and research aptitude.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Ph.D in Pharmaceutical Sciences - Pharmaceutical Chemistry Specialization</h3>
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Ph.D Entrance Examinations & Fellowships</h3>
            ...
            <table className="w-full bg-white">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  ...
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">JRF: ₹31,000/month → SRF: ₹35,000/month. Best for chemistry Ph.D at CSIR labs (CDRI, IICT, NCL).</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 font-bold text-[#006837]">UGC-NET (Pharmaceutical Sciences)</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹31,000/month → ₹35,000/month. For Ph.D at universities and academic research.</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 font-bold text-[#006837]">GATE (Chemistry/Biotechnology)</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹31,000/month. Valid for IITs and MHRD fellowship programs.</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 font-bold text-[#006837]">University Entrance</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">IIT, NIPER, ICT, BITS entrance tests. University-specific fellowships available.</td>
                </tr>
                <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                  <td className="px-6 py-4 font-bold text-[#006837]">Direct Ph.D (Industry-Sponsored)</td>
                  <td className="px-6 py-4 text-sm sm:text-base text-gray-700">Some pharmaceutical companies sponsor Ph.D programs with salary continuation.</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-8">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">International Opportunities</h3>
        ...
        <div>
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-6">Professional Certifications</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">Self-Assessment & Chemistry Foundation Check (September-October 2025)</h3>
                <p className="text-sm sm:text-base text-gray-700">Honestly assess organic chemistry aptitude. Review B.Pharm organic chemistry performance. Test yourself on reaction mechanisms and synthesis problems. If struggled with organic chemistry, reconsider this specialization. Research colleges with good synthesis laboratories and spectroscopy facilities.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">GPAT Registration (October-November 2025)</h3>
                <p className="text-sm sm:text-base text-gray-700">Register on NTA GPAT website. Pharmaceutical Chemistry has highest GPAT weightage (30-35 questions), giving chemistry-strong students an advantage. Pay fees (₹1,400 General, ₹700 SC/ST/OBC). Focus preparation on Pharmaceutical Chemistry section.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">GPAT Examination (January-February 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Appear for 3-hour CBT exam. Pharmaceutical Chemistry section covers organic chemistry, medicinal chemistry, stereochemistry, and drug design concepts. Strong chemistry background helps achieve high percentile.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">GPAT Results & College Research (March-May 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Check results on NTA website. Research M.Pharm Pharmaceutical Chemistry programs. <span className="text-[#006837] font-bold">Critical:</span> Verify synthesis laboratory facilities, spectroscopy equipment (NMR, Mass Spec), and faculty research publications in chemistry journals.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">Counseling & Seat Selection (May-July 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Register for AICTE/state counseling. Submit preferences with Pharmaceutical Chemistry specialization. Prioritize colleges with active chemistry research. Accept seat and pay fees within deadline.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">Document Verification & Admission (July-August 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Report with original documents (B.Pharm degree, mark sheets, GPAT scorecard). Complete admission formalities. Pay tuition fees. Apply for AICTE scholarship if GPAT qualified.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-[#7cb983]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-3">Classes & Laboratory Training Begins (August 2026)</h3>
                <p className="text-sm sm:text-base text-gray-700">Attend orientation. Receive laboratory safety training (working with chemicals, fume hoods, hazardous materials). Learn basic synthesis techniques. Start coursework in advanced organic chemistry. Meet research guide.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">M.Pharm Pharmaceutical Chemistry - Fee Structure</h2>
        </div>
          ...
          <table className="w-full bg-white">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                ...
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹50,000 - ₹1,50,000</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹25,000 - ₹75,000</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 text-gray-900 font-semibold">NIPER / IITs / ICT</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹1,50,000 - ₹3,00,000</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹75,000 - ₹1,50,000</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 text-gray-900 font-semibold">State Government Colleges</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹80,000 - ₹2,00,000</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹40,000 - ₹1,00,000</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 text-gray-900 font-semibold">Private Colleges (Affiliated)</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹2,00,000 - ₹4,50,000</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹1,00,000 - ₹2,25,000</td>
              </tr>
              <tr className="hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
                <td className="px-6 py-4 text-gray-900 font-semibold">Deemed Universities</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹4,00,000 - ₹8,00,000</td>
                <td className="px-6 py-4 text-sm sm:text-base text-gray-700">₹2,00,000 - ₹4,00,000</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837] mb-8">Scholarships & Financial Support</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q1: What is M.Pharm in Pharmaceutical Chemistry?</h3>
          ...
          {/* Q2 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q2: What is the salary after M.Pharm Pharmaceutical Chemistry?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q3 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q3: What is the difference between Pharmaceutical Chemistry and Medicinal Chemistry?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q4 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q4: Can I do PhD after M.Pharm Pharmaceutical Chemistry?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q5 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q5: Is organic chemistry knowledge mandatory for Pharmaceutical Chemistry?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q6 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q6: What is the difference between Pharmaceutical Chemistry and Pharmaceutical Analysis?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q7 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q7: Are jobs available for Pharmaceutical Chemistry graduates in India?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q8 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q8: Can I work in formulation or production after Pharmaceutical Chemistry?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q9 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q9: Is M.Pharm Pharmaceutical Chemistry difficult?</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Q10 */}
          <div className="bg-white rounded-xl p-6 shadow-md border-l-4 border-[#7cb983]">
            <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold text-[#006837] mb-4">Q10: What is the scope of Pharmaceutical Chemistry internationally?</h3>
            <p className="text-gray-700 leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-bold text-[#006837]">Why Choose M.Pharm in Pharmaceutical Chemistry?</h2>
        </div>

        <div className="space-y-6">
          {/* Reason 1 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">1. Design Molecules That Become Medicines</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Reason 2 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">2. Strong Foundation for Drug Discovery Careers</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Reason 3 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">3. Excellent Academic & Research Career Path</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Reason 4 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">4. Intellectual Challenge & Problem-Solving</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Reason 5 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">5. Patent & IP Generation Opportunities</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Reason 6 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">6. Versatile Skill Set with Multiple Applications</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Reason 7 */}
          <div className="bg-gradient-to-br from-[#FBFBEE] to-[#FBFBEE] rounded-xl p-6 border-l-4 border-[#7cb983]">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#006837] mb-4">7. Global Recognition & Mobility</h3>
            <p className="text-gray-700 leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-r from-[#006837] via-[#7cb983] to-[#7cb983] rounded-2xl p-12 text-center shadow-2xl">
          ...
          <a href="https://admission.jkkn.ac.in/form/jkkn-institution-admission-yxs3w8" className="bg-white text-[#006837] px-8 py-4 rounded-full text-xl font-bold hover:bg-gray-100 transition-all shadow-lg transform hover:scale-105 inline-block focus:outline-none focus:ring-2 focus:ring-[#006837] focus:ring-offset-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-12">
        ...
        <ul className="space-y-4 mb-8 text-sm sm:text-base text-gray-700">
          <li className="flex items-start">
            <span className="text-[#006837] mr-3 mt-1">•</span>

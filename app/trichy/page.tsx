...
const config: CityLandingConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Applications for JKKN College of Pharmacy 2026-27 admission are open through the official portal at admission.jkkn.ac.in. Learners from Trichy can also visit the campus in Komarapalayam or call +91-9345855001 for admission guidance and programme details.',
    },
  ],
  exploreCities: [

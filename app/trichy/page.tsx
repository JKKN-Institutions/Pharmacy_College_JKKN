...
const config: CityLandingConfig = {
  ...
  faqs: [
    {
      ...
      answer:
        'JKKN College of Pharmacy in Komarapalayam, about 145 km from Trichy via Namakkal, is a PCI-approved, NAAC-accredited residential college offering B.Pharm, M.Pharm, and Pharm.D. It has a teaching hospital for clinical training, separate hostels, and 78% placements (2024-25).',
    },
    {
  ...
  exploreCities: [
    { city: 'Karur', distance: '84 km', href: '/karur/' },
